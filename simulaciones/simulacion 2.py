...
class TestApp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cursor.execute("INSERT INTO usuarios (email, contraseña, nombre, apellido) VALUES ('chavez@test.com', '2322', 'Ramon', 'Mendes')")
        
        self.conn.commit()

    def tearDown(self):
        self.cursor.execute("DELETE FROM usuarios WHERE email = 'chavez@test.com'")
        self.conn.commit()
        self.conn.close()
    ...
    def test_login(self):
        response = self.app.post('/login', data=dict(email='chavez@test.com', contraseña='2322'), follow_redirects=True)
    ...
    def test_registro_usuario(self):
        ...
        self.cursor.execute("SELECT * FROM usuarios WHERE email = 'chavez@test.com'")
